...
| 文集 | 文件数 | 收录数 | 备注 |
|---|---:|---:|---|
| [全唐诗](markdown/全唐诗) | 1,795 | 60,146 | 全唐诗 + 御定全唐詩 合并去重 |
| [宋词](markdown/宋词) | 734 | 21,050 | 含千家词 |
| [元曲](markdown/元曲) | 196 | 10,914 | 含千家曲 |
| [五代诗词](markdown/五代诗词) | 21 | 543 | 花间集 + 南唐二主词 |
| [纳兰性德](markdown/纳兰性德) | 1 | 257 | 单作者 |
| [曹操诗集](markdown/曹操诗集) | 1 | 26 | 单作者 |
| [楚辞](markdown/楚辞) | 17 | 65 | 按 section 分文件 |
| [诗经](markdown/诗经) | 6 | 305 | 按 chapter（国风/小雅/大雅/颂） |
| [论语](markdown/论语) | 1 | 20 | 全 20 篇合并 |
| [四书五经](markdown/四书五经) | 3 | 16 | 大学 / 中庸 / 孟子 |
| [幽梦影](markdown/幽梦影) | 1 | 219 | 含张潮原文与历代评注 |
| [蒙学](markdown/蒙学) | 15 | 44 | 三字经、千字文、百家姓、古文观止等 |
| **合计** | **2,791** | **93,605** | |
...
- **多产作者**：`<排名>_<作者>_<诗数>.md`（如 [0002_杜甫_1549.md](markdown/全唐诗/0002_杜甫_1_424.md)）。排名按该作者的诗词数量降序，前 4 位补零。
...
- 按书本结构分文件（章/卷/部分）。文件名直接用章节名，如 [国风.md](markdown/诗经/国风.md)、[离骚.md](markdown/楚辞/离骚.md)。
...
作者介绍（仅多文件作者的首份 md，从 authors.json 取）
...
所有转换脚本位于 [scripts/](scripts/)，依赖 `opencc-python-reimplemented`（仅 简化/去重用，可选）：
...
每个脚本读取根目录下对应的中文目录（如 `全唐诗/`、`宋词/`）里的源 JSON，重生成 `markdown/<文集名>/` 下的所有文件。共享辅助函数在 `scripts/_common.py`。
